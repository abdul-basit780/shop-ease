...
import { listProducts, getProduct } from '../../src/lib/controllers/publicProduct';
import { listCategories, getCategory } from '../../src/lib/controllers/publicCategory';
  ...
  describe('Public Categories', () => {
    describe('getCategories', () => {
      it('should get all active categories successfully', async () => {
        ...
        const result = await listCategories(mockReq as NextApiRequest, mockRes as NextApiResponse);
