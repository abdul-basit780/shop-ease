...
describe('recommendation utils', () => {
  describe('buildRecommendationResponse', () => {
    it('should build personalized recommendation response', () => {
      ...
      const response = buildRecommendationResponse(mockRecommendations, 'personalized');
    ...
    it('should build popular recommendation response', () => {
      ...
      const response = buildRecommendationResponse(mockRecommendations, 'popular');
  ...
  describe('RECOMMENDATION_MESSAGES', () => {
    it('should have all required message constants', () => {
      expect(RECOMMENDATION_MESSAGES.RETRIEVED).toBe('Recommendations retrieved successfully');
      expect(RECOMMENDATION_MESSAGES.POPULAR_RETRIEVED).toBe('Popular products retrieved successfully');
      expect(RECOMMENDATION_MESSAGES.TRENDING_RETRIEVED).toBe('Trending products retrieved successfully');
      expect(RECOMMENDATION_MESSAGES.SIMILAR_RETRIEVED).toBe('Similar products retrieved successfully');
      expect(RECOMMENDATION_MESSAGES.PRODUCT_NOT_FOUND).toBe('Product not found');
    });
  });
});
