...
import { Mail, Lock, Eye, EyeOff, User, Calendar, ShoppingBag, Sparkles, CheckCircle, Gift } from 'lucide-react';
            ...
            <div className="hidden lg:block animate-fade-in-left">
              <div className="text-center lg:text-left">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  {[
                    { icon: Gift, title: 'Free Delivery', desc: 'No extra charge for delivery' },
                    { icon: Sparkles, title: 'Personalized Recommendations', desc: 'Personalized for you' },
                    { icon: ShoppingBag, title: 'Exclusive Deals', desc: 'Member-only offers' },
                    { icon: CheckCircle, title: 'Priority Support', desc: '24/7 assistance' },
                  ].map((benefit, idx) => {
                ...
                <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-3xl p-6 text-white shadow-2xl">
                  ...
                  <p className="text-primary-100">Join our community of satisfied shoppers today!</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full animate-scale-in">
              ...
              <div className="lg:hidden text-center mb-8">
                ...
                <h1 className="text-3xl font-extrabold text-gray-900 mb-2">
                  Create <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600">Account</span>
                </h1>
                    ...
                    <div className="animate-fade-in-up animation-delay-600">
                      <label className="flex items-start cursor-pointer group">
                        ...
                        <span className="ml-3 text-sm text-gray-700 group-hover:text-gray-900">
                          I agree to the{' '}
                          <Link href="/terms" className="text-primary-600 hover:text-primary-700 font-semibold hover:underline">
                            Terms and Conditions
                          </Link>{' '}
                          and{' '}
                          <Link href="/privacy" className="text-primary-600 hover:text-primary-700 font-semibold hover:underline">
                            Privacy Policy
                          </Link>
                        </span>
                      </label>
